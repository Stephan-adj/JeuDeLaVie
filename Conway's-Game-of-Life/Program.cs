//Made by CONTE BOURGES Aymar & ADJARIAN Stéphan TDA - ESILV A1
using System;
...
namespace ProjetTD_6et7
{
    class Program
    {
        ...
        static int[,] GenerationGame(Random rand, int answer)//Aymar
        ...
        static int[,] CanonAPlaneur()//Stéphan
        ...
        static void DimensionEtc()//Stéphan
        ...
        static void AffichageInformations(int[,] game, int nbrGeneration, int answer, Fenetre gui)//Stéphan
        ...
        static void AfficherGameSansVisualisation(int[,] game)//Stéphan
        ...
        static void AfficherGameAvecVisualisation(int [,] previsualisation)//Stéphan
        ...
        static int NbrCellulesVivantes(int[,] game, int numeroAssocieAlaPopulation)//Stéphan
        ...
        static bool ChoixPasAPas()//Stéphan
        ...
        static string PassageNextStep(bool pasApas)//Stéphan
            ...
            //Et si l'utilisateur entre "0" le jeu s'arrete
        {
            ...
            //récolte
        static int CompteurVoisinsVivantsRang1(int[,] game, int indiceLignes, int indiceColonnes, int population)//Stéphan
        ...
        static int CompteurVoisinsVivantsRang2(int[,] game, int indiceLignes, int indiceColonnes, int population)//Stéphan
            //Cette fonction compte le nombre de voisin vivant de la même population d'une cellule au rang 2
        {
            ...
            //stockage
        static int[,] RemplissageMatriceVoisinsVivantsRang1(int[,] game, int population)//Aymar
        ...
        static int[,] RemplissageMatriceVoisinsVivantsRang2(int[,] game, int population)//Aymar
        ...
        static int EtatCelluleAuTourSuivant(int[,] game, int indexLigne, int indexColonne, int nbdeVoisinVivant)//Aymar
        ...
        static int EtatCelluleAuTourSuivantPourPrevisualiser(int[,] game, int indexLigne, int indexColonne, int nbdeVoisinVivant)//Aymar
        ...
        static int EtatCelluleAuTourSuivant2Popu(int[,] game, int indexLigne, int indexColonne, int[,] MatriceNbrVoisinsVivantsPopulation1rang1, int[,] MatriceNbrVoisinsVivantsPopulation2rang1, int[,] MatriceNbrVoisinVivantPopulation1rang2, int[,] MatriceNbrVoisinVivantPopulation2rang2)//Aymar
        ...
        static int EtatCelluleAuTourSuivant2PourPrevisualiser(int[,] game, int indexLigne, int indexColonne, int[,] MatriceNbrVoisinsVivantsPopulation1rang1, int[,] MatriceNbrVoisinsVivantsPopulation2rang1, int[,] MatriceNbrVoisinVivantPopulation1rang2, int[,] MatriceNbrVoisinVivantPopulation2rang2)//Aymar
        ...
        static int[,] GameTourDaprès(int[,] game, int NbrPopulation, int[,] MatriceNbrVoisinsVivantsPopulation1rang1, int[,] MatriceNbrVoisinsVivantsPopulation2, int[,] MatriceNbrVoisinVivantPopulation1rang2, int[,] MatriceNbrVoisinVivantPopulation2rang2)//Aymar
        ...
        static void ModificationPourPrevisualisation(int[,] game, int[,] MatriceNbrVoisinsVivantsPopulation1rang1, int population)//Aymar
        ...
        static void ModificationPourPrevisualisationAvec2Population(int[,] game, int[,] MatriceNbrVoisinsVivantsPopulation1rang1, int[,] MatriceNbrVoisinsVivantsPopulation2, int[,] MatriceNbrVoisinVivantPopulation1rang2, int[,] MatriceNbrVoisinVivantPopulation2rang2)//Aymar
            //Cette fonction permet de créer une matrice (temporaire uniquement pour la prévisualisation) 
            //Pour calculer les états futurs de chaque cellule, elle copie ensuite tout dans la matrice game
        {
            int[,] previsualisation = new int[game.GetLength(0), game.GetLength(1)];
        ...
        static void GameTourDApresAvecPrevisualisation(int[,] game)//Stéphan
